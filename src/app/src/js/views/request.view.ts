...
export class RequestView extends BaseView {
  ...
  private usernameTimeout: number | null = null;
  ...
  private setupEventListeners(): void {
    const form = this.element.querySelector('#user-request-form') as HTMLFormElement;
  ...
  private async handleUsernameInput(event: Event): Promise<void> {
    const input = event.target as HTMLInputElement;
    const validationLabel = this.element.querySelector('.username-validation') as HTMLElement;
