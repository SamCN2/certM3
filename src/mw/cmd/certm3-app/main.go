...
func main() {
	...
	// Create handler
	h := app.NewHandler(logger, m, jwtManager, client, config.AppServer.BackendAPIURL, *testAPI, config)
	...
	r.HandleFunc("/app/health", func(w http.ResponseWriter, r *http.Request) {
